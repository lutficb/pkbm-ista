            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit kegiatan siswa</h4>
                    </div>
                    <div class="card-body">
                        <form id="updatePages" action="<?= base_url('kegiatan/' . $kegiatan->id); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="PUT">
                            <input type="hidden" name="file_lama" value="<?= $kegiatan->gambar; ?>">
                            <div class="form-group row mb-4">
                                <label for="nama_kegiatan" class="col-form-label text-md-right col-12 col-md-3 col-lg-3 ">Nama Kegiatan</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control <?= $validation->hasError('nama_kegiatan') ? 'is-invalid' : null; ?>" name="nama_kegiatan" id="nama_kegiatan" value="<?= old('nama_kegiatan', $kegiatan->nama_kegiatan); ?>" required>
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric <?= $validation->hasError('kode_kategori') ? 'is-invalid' : null; ?>" name="kode_kategori" id="kode_kategori">
                                        ...
                                        <?php foreach ($kategori as $key => $value) : ?>
                                            <option value="<?= $value->slug; ?>" <?= ($value->slug == old('kode_kategori') || $value->slug == $kegiatan->kode_kategori) ? 'selected' : ''; ?>><?= $value->nama_kategori; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label label-page-thumbnail" for="gambar"><?= $kegiatan->gambar; ?></label>
                                    </div>
                                    <small><b>Gunakan gambar dengan resolusi 1280 x 720 pixel untuk hasil terbaik</b></small>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <img src="<?= base_url('assets/img/img-kegiatan/' . $kegiatan->gambar); ?>" alt="" class="img-thumbnail thumb-preview">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="info_kegiatan" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Isi Konten</label>
                                <div class="col-sm-12 col-md-7">
                                    <textarea class="summernote-simple <?= $validation->hasError('info_kegiatan') ? 'is-invalid' : null; ?>" name="info_kegiatan" id="info_kegiatan" required><?= old('info_kegiatan', $kegiatan->info_kegiatan); ?></textarea>
                                    <div class="invalid-feedback mt-1">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <button class="btn btn-primary"><i class="fas fa-save"></i> Update Post</button>
                                </div>
                            </div>
                        </form>
                    </div>
