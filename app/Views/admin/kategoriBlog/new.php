...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= base_url('kategori-blog'); ?>" class="btn"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1><?= $subtitle; ?></h1>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Input kategori blog baru.</h4>
                    </div>
                    <div class="card-body">
                        <form id="updatePages" action="<?= base_url('kategori-blog'); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <img src="<?= base_url('assets/img/blog-kategori/img-default.jpg'); ?>" alt="" class="img-thumbnail thumb-preview">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
