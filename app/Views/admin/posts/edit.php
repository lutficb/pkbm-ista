        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="updatePages" action="<?= base_url('posts/' . $post->id); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="PUT">
                            <input type="hidden" name="file_lama" value="<?= $post->thumbnail; ?>">
                            <div class="form-group row mb-4">
                                <label for="judul_post" class="col-form-label text-md-right col-12 col-md-3 col-lg-3 ">Judul Post</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control <?= $validation->hasError('judul_post') ? 'is-invalid' : null; ?>" name="judul_post" id="judul_post" value="<?= old('judul_post', $post->judul_post); ?>" required>
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric <?= $validation->hasError('kode_kategori') ? 'is-invalid' : null; ?>" name="kode_kategori" id="kode_kategori">
                                        ...
                                        <?php foreach ($kategori as $key => $value) : ?>
                                            <option value="<?= $value->slug; ?>" <?= ($value->slug == old('kode_kategori') || $value->slug == $post->kode_kategori) ? 'selected' : ''; ?>><?= $value->nama_kategori; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label label-page-thumbnail" for="thumbnail"><?= $post->thumbnail; ?></label>
                                    </div>
                                    <small><b>Gunakan gambar dengan resolusi 800 x 533 pixel untuk hasil terbaik</b></small>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <img src="<?= base_url('assets/img/img-post/' . $post->thumbnail); ?>" alt="" class="img-thumbnail thumb-preview">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="konten_post" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Isi Konten</label>
                                <div class="col-sm-12 col-md-7">
                                    <textarea class="summernote-custom <?= $validation->hasError('konten_post') ? 'is-invalid' : null; ?>" name="konten_post" id="konten_post" required><?= old('konten_post', $post->konten_post); ?></textarea>
                                    <div class="invalid-feedback mt-1">
