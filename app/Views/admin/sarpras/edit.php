            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit sarana dan prasarana</h4>
                    </div>
                    <div class="card-body">
                        <form id="updatePages" action="<?= base_url('sarpras/' . $sarpras->id); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <input type="hidden" name="_method" value="PUT">
                            <input type="hidden" name="file_lama" value="<?= $sarpras->gambar; ?>">
                            <div class="form-group row mb-4">
                                <label for="judul_gambar" class="col-form-label text-md-right col-12 col-md-3 col-lg-3 ">Nama Sarpras</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control <?= $validation->hasError('judul_gambar') ? 'is-invalid' : null; ?>" name="judul_gambar" id="judul_gambar" value="<?= old('judul_gambar', $sarpras->judul_gambar); ?>" required>
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric <?= $validation->hasError('kode_kategori') ? 'is-invalid' : null; ?>" name="kode_kategori" id="kode_kategori">
                                        ...
                                        <?php foreach ($kategori as $key => $value) : ?>
                                            <option value="<?= $value->slug; ?>" <?= ($value->slug == old('kode_kategori') || $value->slug == $sarpras->kode_kategori) ? 'selected' : ''; ?>><?= $value->nama_kategori; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-3">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label label-page-thumbnail" for="gambar"><?= $sarpras->gambar; ?></label>
                                    </div>
                                    <small><b>Gunakan gambar dengan resolusi 1280 x 720 pixel untuk hasil terbaik</b></small>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <img src="<?= base_url('assets/img/img-sarpras/' . $sarpras->gambar); ?>" alt="" class="img-thumbnail thumb-preview">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="info_gambar" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Isi Konten</label>
                                <div class="col-sm-12 col-md-7">
                                    <textarea class="summernote-simple <?= $validation->hasError('info_gambar') ? 'is-invalid' : null; ?>" name="info_gambar" id="info_gambar" required><?= old('info_gambar', $sarpras->info_gambar); ?></textarea>
                                    <div class="invalid-feedback mt-1">
