            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit kategori sarpras.</h4>
                    </div>
                    <div class="card-body">
                        <form id="updatePages" action="<?= base_url('kategori-sarpras/' . $kategori->id); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <img src="<?= base_url('assets/img/img-sarpras/' . $kategori->thumbnail); ?>" alt="" class="img-thumbnail thumb-preview">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
